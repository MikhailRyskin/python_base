...
# TODO Это описание перенесите в парсер в параметр "description"
...
# TODO По поводу параметра "--result" или "-result" здесь имеется ввиду что с помощью этой метки передают данные.
