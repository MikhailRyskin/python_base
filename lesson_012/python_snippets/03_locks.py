...
#
# Одна из них - доступ к совместным данным: если два потока меняют один и тот же объект,
...
# В момент вызова self.lock.acquire() асинхронные потоки синхронизируются по времени.
...
# Один поток заблокировал ресурс A и ему нужен ресурс Б, а другой поток наоборот - заблокировал Б и ждет А.
