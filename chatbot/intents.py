    ...
    'booking': {
        ...
        'steps': {
            ...
            'step3': {
                ...
                'failure_text': 'Некорректный формат даты или дата меньше текущей или нет рейса.'
                ' Попробуйте ещё раз.',
                'handler': 'handle_date',
                'next_step': 'step4'
            },
            'step4': {
                ...
                'failure_text': 'Этого номера нет в списке. Попробуйте ещё раз.',
                'handler': 'handle_flights',
                'next_step': 'step5'
            },
            'step5': {
                'text': 'Введите количество мест (от 1 до 5)',
                'failure_text': 'Неверное количество мест. Попробуйте ещё раз.',
                'handler': 'handle_seats',
                'next_step': 'step6'
            },
            'step6': {
                'text': 'Дополнительные комментарии (или "нет").',
                'failure_text': 'Некорректный комментарий. Попробуйте ещё раз.',
            ...
            'step9': {
                'text': 'Спасибо за заказ. Мы свяжемся с Вами по номеру {phone} в ближайшее время.'
                        ' Сохраните или распечатайте билет ниже.',
